Public Class FrmBusquedaHermanovb
    Private Sub FrmBusquedaHermanovb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        accesodatos.Cargarhermanos(DataGridView1)
    ...
    Private Sub txtBuscar_TextChanged(sender As Object, e As EventArgs) Handles txtBuscar.TextChanged
        ...
        accesodatos.Cargarhermanos(DataGridView1, txtBuscar.Text)
    End Sub


    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        FrmHermanos.esBuscar = True
