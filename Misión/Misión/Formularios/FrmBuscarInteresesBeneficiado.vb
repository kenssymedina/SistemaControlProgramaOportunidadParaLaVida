Public Class FrmBuscarInteresesBeneficiado
    Private Sub FrmBuscarInteresesBeneficiado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        accesodatos.CargarIntereses(DataGridView1)
    End Sub
    ...
    Private Sub txtBuscar_TextChanged(sender As Object, e As EventArgs) Handles txtBuscar.TextChanged
        ...
        accesodatos.CargarIntereses(DataGridView1, txtBuscar.Text)
    End Sub
