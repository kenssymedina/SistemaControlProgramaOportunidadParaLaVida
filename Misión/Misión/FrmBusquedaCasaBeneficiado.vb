Public Class FrmBusquedaCasaBeneficiado

    Private Sub FrmBusquedaCasaBeneficiado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        accesodatos.CargarCasaBeneficiaado(DataGridView1)
    End Sub
    ...
    Private Sub txtBuscar_TextChanged(sender As Object, e As EventArgs) Handles txtBuscar.TextChanged
        ...
        accesodatos.CargarCasaBeneficiaado(DataGridView1, txtBuscar.Text)
    End Sub


    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        'aqui obtiene el id de sql osea la pk de la tabla que se esta mostran\do en el grid
