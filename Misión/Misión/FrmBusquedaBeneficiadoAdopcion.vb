Public Class FrmBusquedaBeneficiadoAdopcion
    Private Sub FrmBusquedaBeneficiadoAdopcion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        accesodatos.CargarBeneficiadoAdopcion(DataGridView1)
    End Sub
    ...
    Private Sub txtBuscar_TextChanged(sender As Object, e As EventArgs) Handles txtBuscar.TextChanged
        ...
        accesodatos.CargarBeneficiadoAdopcion(DataGridView1, txtBuscar.Text)
    End Sub
