Public Class FrmBusquedaUsuario
    Private Sub FrmBusquedaUsuario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        accesodatos.CargarUsuario(DataGridView1)
    End Sub
    ...
    Private Sub txtBuscar_TextChanged(sender As Object, e As EventArgs) Handles txtBuscar.TextChanged
        ...
        accesodatos.CargarUsuario(DataGridView1, txtBuscar.Text)
    End Sub
