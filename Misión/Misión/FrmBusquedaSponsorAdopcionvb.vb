Public Class FrmBusquedaSponsorAdopcionvb
    Private Sub FrmBusquedaSponsorAdopcionvb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        accesodatos.CargarSponsorAdopcion(DataGridView1)
    End Sub
    ...
    Private Sub txtBuscar_TextChanged(sender As Object, e As EventArgs) Handles txtBuscar.TextChanged
        ...
        accesodatos.CargarSponsorAdopcion(DataGridView1, txtBuscar.Text)
    End Sub
